...
import NyayagptHeader from "./NyayagptHeader";
import NyayagptHeroSection from "./NyayagptHeroSection";
import NyayagptOurServices from "./NyayagptOurServices";
import Nyayagptfooter from "./Nyayagptfooter";
...
export default function Nyayagpt() {

      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="bg-white rounded-xl p-4 text-center shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 border border-purple-100">
            ...
            <div className="text-gray-600 text-xs font-medium">Happy Students</div>
          </div>
          <div className="bg-white rounded-xl p-4 text-center shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 border border-blue-100">
            ...
            <div className="text-gray-600 text-xs font-medium">UK Universities</div>
          </div>
          <div className="bg-white rounded-xl p-4 text-center shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 border border-green-100">
            ...
            <div className="text-gray-600 text-xs font-medium">Study Programs</div>
          </div>
          <div className="bg-white rounded-xl p-4 text-center shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 border border-orange-100">
            ...
            <div className="text-gray-600 text-xs font-medium">Scholarship Programs</div>
          </div>
        </div>
        ...
        <div className="flex flex-col xl:flex-row gap-6 mb-8">
          ...
          <div className="xl:w-3/5 bg-gradient-to-br from-indigo-50 to-purple-50 rounded-2xl overflow-hidden shadow-xl border border-purple-100">
            <div className="relative">
              {/* Video Thumbnail */}
              <div className="relative aspect-video bg-gradient-to-br from-gray-900 to-gray-800 overflow-hidden cursor-pointer group" onClick={openVideoModal}>
                <img 
                  src={thumbnailImage}
              ...
              <div className="p-6">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h3 className="text-xl font-bold text-gray-900 mb-2">Discover UK Education Excellence</h3>
                ...
                <div className="grid grid-cols-3 gap-4 mt-6">
                  <div className="text-center p-3 bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 border border-purple-100">
                    ...
                    <p className="text-xs font-semibold text-gray-700">World Rankings</p>
                  </div>
                  <div className="text-center p-3 bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 border border-blue-100">
                    ...
                    <p className="text-xs font-semibold text-gray-700">Global Recognition</p>
                  </div>
                  <div className="text-center p-3 bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 border border-green-100">
                    ...
                    <p className="text-xs font-semibold text-gray-700">Scholarships</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="xl:w-2/5 bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl p-6 shadow-xl border border-blue-100">
            ...
            <div className="space-y-4 mb-6">
              {universities.slice(0, 4).map((uni, index) => (
                <div key={index} className="bg-white p-4 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 border border-gray-100 hover:border-blue-200 group">
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      ...
                      <div className="flex justify-between text-xs">
                        ...
                        <span className="font-bold text-green-600 text-sm">{uni.scholarshipAmount}</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              {displayedUniversities.map((university, index) => (
                ...
                >
                  ...
                  <div className="p-5 flex flex-col flex-1">
                    <div className="flex-1">
                      <h4 className="text-lg font-bold text-gray-900 line-clamp-2 mb-3 group-hover:text-purple-600 transition-colors duration-300"
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
            {[
              ...
              >
                ...
                <div className={`text-sm font-bold bg-gradient-to-r ${program.color} bg-clip-text text-transparent mb-1`}>
                  {program.count} Courses
                </div>
                <p className="text-xs text-gray-500 font-medium">{program.universities}</p>
              </div>
            ))}
          </div>
        </div>
                ...
                <div className="text-center py-8">
                  ...
                  <div className="bg-green-50 border border-green-200 rounded-xl p-6 mb-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                      ...
                      <div className="bg-white p-4 rounded-lg shadow-md">
                        <div className="text-xl font-bold text-green-600 mb-1">💸 Save ₹1,50,000</div>
                  ...
                  <div className="bg-gray-50 p-5 rounded-xl text-left mb-6">
                    ...
                    <p className="text-sm mb-1"><span className="font-semibold">Course:</span> {applicationData.selectedCourse}</p>
                    <p className="text-sm mb-1"><span className="font-semibold">University:</span> {selectedUniversityForApplication.name}</p>
                    <p className="text-sm mb-1"><span className="font-semibold">Intake:</span> {applicationData.intake}</p>
                    ...
                    <div className="bg-gray-50 p-4 rounded-xl mb-4">
                      ...
                      {selectedUniversityForApplication.scholarshipAmount && (
                        <div className="bg-green-100 p-3 rounded-lg mt-3">
                          <p className="text-sm text-green-800">
                            <span className="font-semibold">🎓 Scholarship Available:</span> {selectedUniversityForApplication.scholarshipAmount}
                          </p>
                        </div>
                      )}
                      ...
                      <div className="bg-blue-100 p-3 rounded-lg mt-3">
                        <p className="text-sm text-blue-800">
                          <span className="font-semibold">💰 Special Offer:</span> 5% Cashback + Save up to ₹1,50,000
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="space-y-5">
                             ...
                             <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                               <div className="space-y-3">
                                 <div className="text-sm">
                                   ...
                                   <p className="text-gray-900 mt-1 font-medium">{selectedCourse.courseName}</p>
                                 </div>
                                 {selectedCourse.degree && (
                                   <div className="text-sm">
                                     <span className="font-semibold text-gray-700">Degree Type:</span>
                                     <p className="text-gray-900 mt-1 font-medium">{selectedCourse.degree}</p>
                                   </div>
                                 )}
                                 {selectedCourse.tutionFee1styr && (
                                   <div className="text-sm">
                                     <span className="font-semibold text-gray-700">Tuition Fee (1st Year):</span>
                                     <p className="text-green-600 font-bold mt-1 text-base">{selectedCourse.tutionFee1styr}</p>
                                   </div>
                                 )}
                               </div>
                               <div className="space-y-3">
                                 {selectedCourse.applicationFee && (
                                   <div className="text-sm">
                                     ...
                                     <p className="text-blue-600 font-bold mt-1 text-base">{selectedCourse.applicationFee}</p>
                                   </div>
                                 )}
                                 {(selectedCourse.intake || selectedCourse.intake2 || selectedCourse.intake3) && (
                                   <div className="text-sm">
                                     <span className="font-semibold text-gray-700">Available Intakes:</span>
                     ...
                     <div className="bg-green-50 border border-green-200 rounded-xl p-4">
                       <div className="flex items-center gap-2 mb-3">
                         ...
                         <h5 className="font-bold text-green-800 text-base">Your Benefits Upon Application:</h5>
                       </div>
                       <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                         <div className="flex items-center gap-2">
                           <span className="text-green-600 text-lg">💰</span>
                           <span className="text-green-700 font-semibold">5% Cashback on fees</span>
                         </div>
                         <div className="flex items-center gap-2">
                           <span className="text-green-600 text-lg">💸</span>
                           <span className="text-green-700 font-semibold">Save up to ₹1,50,000</span>
                         </div>
                         <div className="flex items-center gap-2">
                           <span className="text-green-600 text-lg">🎓</span>
                           <span className="text-green-700 font-semibold">Scholarship opportunities</span>
                         </div>
                         <div className="flex items-center gap-2">
                           <span className="text-green-600 text-lg">⚡</span>
                           <span className="text-green-700 font-semibold">Fast processing</span>
                         </div>
                       </div>
                     </div>

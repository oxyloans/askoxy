        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          <div className="flex items-center">
            ...
            <h1 className="ml-2 sm:ml-3 text-lg sm:text-xl md:text-2xl font-bold text-gray-900 truncate">
              <span className="hidden sm:inline">ASKOXY.AI</span> Design
              Templates
            </h1>
          </div>
      ...
      <main className="flex-grow max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10 w-full">
        <div className="text-center mb-8 sm:mb-12">
          ...
          <p className="mt-2 text-gray-600 max-w-2xl mx-auto">
            Select a template and start customizing your design with our
            intuitive editor
          </p>
        </div>
          ...
          {templates.map((template) => (
            ...
            >
              <div className="p-4 sm:p-5 text-center">
                <h3 className="font-medium text-lg sm:text-xl text-gray-900">
                  {template.name}
                </h3>
        ...
        {templates.length === 0 && (
          <div className="text-center py-16">
            ...
            <p className="mt-1 text-gray-500">
              Check back later for new template options
            </p>
          </div>
        )}
      </main>
      ...
      <section className="bg-purple-700 py-8 sm:py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-xl sm:text-2xl font-bold text-white mb-4">
            Ready to create your own custom template?
          </h2>
          <p className="text-purple-100 mb-6 max-w-2xl mx-auto">
            Start from scratch and build a unique design that perfectly fits
            your brand
          </p>
        </div>
      </section>

...
const RadhaInstructionView: React.FC = () => {
  ...
  const renderInteractionItem = (interaction: Interaction) => (
    <div className="mb-6 last:mb-0" key={interaction.employeeConversionDate}>
      <Card

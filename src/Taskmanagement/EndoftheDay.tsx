...
//         });
//         // UPDATE: Redirect to PlanOfTheDay if no pending tasks and coming from there
//         if (sessionStorage.getItem("fromPlanOfTheDay") === "true") {
//           sessionStorage.removeItem("fromPlanOfTheDay");
//           navigate("/plan-of-the-day");
//         }
//       }
//     } catch (error: any) {
//       notification.error({

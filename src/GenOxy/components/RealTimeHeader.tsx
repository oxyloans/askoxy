    ...
    <header className="fixed top-0 left-0 right-0 z-50 p-3 sm:p-4">
      ...
      <div className="relative flex justify-between items-center">
        ...
        <div className="flex items-center gap-4">
          ...
          {!hideButtons && isSessionActive && (
            <div className="flex items-center gap-2 px-3 py-2 bg-gradient-to-r from-orange-500/20 to-red-500/20 backdrop-blur-sm rounded-full border border-orange-500/30">
              <div className="w-2 h-2 bg-orange-400 rounded-full animate-pulse"></div>
              <span className="text-orange-300 font-mono text-sm font-semibold">

...
function DynamicVideo({ isAssistantSpeaking }: { isAssistantSpeaking: boolean }) {
  ...
  }, [isAssistantSpeaking, videoLoaded, videoError]);
  ...
  return (
    <div className="w-full h-full rounded-2xl overflow-hidden bg-gradient-to-br from-gray-900 to-gray-800">
      {!videoError ? (
        ...
        >
          <source
            src="https://oxybricksv1.s3.ap-south-1.amazonaws.com/null/45880e62-acaf-4645-a83e-d1c8498e923e/aadhar_AiVideovoice.mp4"
            type="video/mp4"
          />
        </video>
      ) : (
        <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-gray-900 to-gray-800">
          <div className="text-center">
            ...
            <p className="text-white text-xl font-medium">AI Assistant</p>
      ...
      <div className="relative z-10 flex h-screen pt-20">
        ...
        <div className="w-2/5 p-6 flex items-center justify-center">
          <div className="w-full h-96 flex items-center justify-center">
            <DynamicVideo isAssistantSpeaking={isAssistantSpeaking} />
          </div>
        </div>
              ...
              <div className="flex items-center justify-center h-full">
                <div className="text-center">
                  ...
                  <p className="text-gray-300 text-lg">
                    {selectedLanguage.code === "te" && "మాట్లాడటం ప్రారంభించండి..."}

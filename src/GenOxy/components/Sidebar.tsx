...
const handleMobileClick = (callback: () => void) => {
  ...
  return (
    <div className="flex flex-col h-full bg-white dark:bg-gray-800 shadow-sm relative pb-24">
      {" "}
      ...
      <div className="flex items-center justify-between px-2 py-1 border-b border-gray-200 dark:border-gray-700">
        ...
        <div className="sm:hidden">
          <button
            ...
            className="p-2 pt-4 text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white"
      ...
      {/* Fixed Powered By Section */}
      <div className="absolute bottom-0 w-full px-4 py-3  border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
        {" "}
        {/* Fixed to bottom with absolute positioning */}
        ...
        <div className="mt-2 flex flex-col items-center gap-2">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="text-[12px] sm:text-sm font-semibold text-purple-700 dark:text-purple-300 hover:underline"
          >
            ASKOXY.AI
          </a>
          <a

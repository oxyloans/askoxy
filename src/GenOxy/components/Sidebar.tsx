...
import { X, Trash2, User, Sparkles, History } from "lucide-react";
      ...
      <div className="flex items-center justify-between p-3 border-b border-gray-200 dark:border-gray-700">
        ...
        <div className="hidden sm:flex rounded-lg  items-center justify-center transition-shadow duration-200">
          <button onClick={clearChat}>
            <Sparkles className="w-6 h-6 text-purple-800 rounded-lg bg-gray-50" />
          </button>
        </div>
        <div className="hidden sm:flex flex-1 justify-center" />
        {/* New Chat button - visible on all screens, but aligned left on mobile */}
        <div className="flex-1 flex sm:justify-center justify-start">
          <button
            onClick={clearChat}
            className="flex items-center gap-2 text-sm font-semibold text-purple-800 dark:bg-gray-800 px-3 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-all duration-200"
          >
            <svg
              width="16"
              height="16"
            ...
            <span className="sm:inline font-semibold dark:text-purple-800 text-purple-600">
              New Chat
            </span>
          </button>
        </div>

          ...
          <>
            ...
            {filteredData.items.length > 0 && (
              <>
                  ...
                  >
                    <Card
                      ...
                      bodyStyle={{
                        padding: "8px 6px",
                        display: "flex",
                        flexDirection: "column", // ✅ IMPORTANT: stack vertically
                        alignItems: "center",
                    ...
                    >
                      <Image
                        src="https://i.ibb.co/LDWKjwn9/all-items-ebf30412cf8992d42b1b.png"
                        alt="All Items"
                        height={48}
                        width={48}
                        preview={false}
                        style={{
                          ...
                          padding: 3,
                          background:
                            selectedCategory === null ? "#f5f0ff" : "#fafafa",
                      ...
                      <Text
                        strong
                        style={{
                          color: selectedCategory === null ? "#5c3391" : "#333",
                          fontSize: 11,
                          lineHeight: "14px",
                          textAlign: "center",
                        }}
                ...
                {selectedCategory === null ? (
                  // ✅ ALL: show one grid ONLY ONCE (no repeat)
                  ...
                  // ✅ CATEGORY selected: ONLY that category items (others disappear)
                  <div className="search-grid-wrap">
                    <div className="search-grid">
                      {filteredData.items
                        .find((c) => c.categoryName === selectedCategory)
                        ?.itemsResponseDtoList.map((product) => {
                          if (
                            !isValidNumber(product.itemPrice) ||
                            !isValidNumber(product.itemMrp)
                          ) {

        ...
        <div className="bg-white rounded-xl shadow-md border border-gray-200 p-8 space-y-6">
          ...
          <section>
            ...
            {expandedSections.description && (
              <p
                ...
                className="text-gray-700 leading-relaxed text-base"
              >
                This use case describes the process of prioritizing Queues in
                the Collections System. Queues are created based on
                classification rules for delinquent accounts, and prioritization
                ensures that if a case qualifies for multiple Queues, it is
                assigned to the one with the highest priority.
              </p>
            )}
          </section>
          ...
          <section>
            ...
            {expandedSections.trigger && (
              <p
                ...
                className="text-gray-700 leading-relaxed text-base"
              >
                Completion of the Beginning of Day (BOD) process and
                availability of delinquent customer details.
              </p>
            )}
          </section>
          ...
          <section>
            ...
            {expandedSections.basicFlow && (
              ...
              >
                <li>
                  User defines Queues by mapping classification rules to
                  products and financiers.
                </li>
          ...
          <section>
            ...
            {expandedSections.exceptionFlows && (
              ...
              >
                <li>
                  Queue creation fails due to missing classification mapping.
                </li>
          ...
          <section>
            ...
            {expandedSections.businessRules && (
              ...
              >
                ...
                <li>
                  Each Queue must be associated with a valid strategy and
                  financier.
                </li>
              </ul>
            )}
          ...
          <section>
            ...
            {expandedSections.assumptions && (
              ...
              >
                <li>
                  Classification rules and product-financier mappings are

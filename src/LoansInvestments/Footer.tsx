        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
          ...
          <div className="col-span-1 md:col-span-2 lg:col-span-1">
            ...
            <p className="text-white text-sm leading-relaxed mb-6">
              Explore tailored financial solutions with our Loans & Investments
              services. Whether you're looking to fund a personal goal, grow
              your business, or invest for future returns, we offer flexible
              loan options and smart investment opportunities designed to meet

...
const socialLinks = [
  ...
  },
  {
    ...
    href: "https://www.threads.net/@askoxy.ai", // replace if you have correct profile link
    label: "Threads",
  },
];
    ...
    <footer className="bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white py-6">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* Our Platforms (FIXED: Link instead of a href) */}
          <div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-xs text-gray-400">
          <p>
            &copy; {new Date().getFullYear()} Loans & Investments. All rights
            reserved.
          </p>
          <button
            onClick={scrollToTop}

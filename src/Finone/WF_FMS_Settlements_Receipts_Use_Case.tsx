...
interface WF_FMS_Settlements_Receipts_Use_CaseProps {}

const WF_FMS_Settlements_Receipts_Use_Case: React.FC<WF_FMS_Settlements_Receipts_Use_CaseProps> = () => {
  return (
      ...
      <div className="bg-white rounded-lg shadow-lg border border-gray-200 p-8">
        ...
        <section className="mb-8">
          ...
          <ol className="list-decimal pl-5 text-gray-700">
            <li>User logs into FMS.</li>
            <li>Navigates to Settlements Receipts screen.</li>
            <li>
            ...
            <li>System validates and records receipt advice.</li>
            <li>
              For cheque payments, processes via:
              <ul className="list-disc pl-5 mt-2">
                <li>Receipt</li>
                <li>Deposit (Maker & Checker)</li>
                <li>Realization (Maker & Checker)</li>
              </ul>
            </li>
            <li>
            ...
            <li>
              System prompts for and generates payment voucher upon successful
              save.
            </li>
            <li>Voucher is printed for physical confirmation.</li>
          </ol>
        </section>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-5 text-gray-700">
            <li>Receipt advice must be generated in system.</li>
            <li>Customer or transaction reference available.</li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-5 text-gray-700">
            <li>Payment details recorded and voucher generated.</li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-5 text-gray-700">
            ...
            <li>POS-based transactions processed directly.</li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-5 text-gray-700">
            ...
            <li>Invalid Cheque ID or Account Number.</li>
            <li>Payment mismatch or duplication error.</li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-5 text-gray-700">
            <li>
              Add integration with real-time bank systems for cheque clearance
              status.
            </li>
            <li>Implement automated duplicate cheque detection.</li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-5 text-gray-700">
            <li>Receipt entry through all payment modes.</li>
            <li>Cheque realization with Maker & Checker.</li>
            <li>Voucher printing on receipt save.</li>
            <li>Input validation for incomplete or incorrect data.</li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-5 text-gray-700">
            <li>Ensure stable printer connectivity for voucher generation.</li>
            <li>Audit trail must be logged for all receipt entries.</li>
          </ul>
        </section>
...
export default WF_FMS_Settlements_Receipts_Use_Case;
...
const AssignedFreelancers: React.FC<AssignedFreelancersProps> = ({
  ...
  const [assignedFreelancers, setAssignedFreelancers] = useState<AssignedFreelancer[]>([]);
  ...
  const getStatusColor = (status: string) => {
    ...
    if (statusUpper === "OPEN") return { color: "#52c41a", bg: "#f6ffed", border: "#b7eb8f" };
    if (statusUpper === "CLOSED") return { color: "#ff4d4f", bg: "#fff2f0", border: "#ffccc7" };
    if (statusUpper === "ON_HOLD") return { color: "#faad14", bg: "#fffbe6", border: "#ffe58f" };
  ...
  const columns = [
    ...
    },
    {
      ...
      align: "center" as const,
      width: 80,
      render: (record: AssignedFreelancer) => (
          ...
          locale={{
            emptyText: (
              <div style={{ padding: "60px 20px", textAlign: "center" }}>
                <EyeOutlined style={{ fontSize: 56, color: "#bfbfbf", marginBottom: 20, display: "block" }} />
                <p style={{ fontSize: 18, color: "#333", marginBottom: 8, fontWeight: 600 }}>No Assigned Freelancers</p>
                <p style={{ fontSize: 13, color: "#999" }}>No freelancers have been assigned to this company yet.</p>
              </div>
            ),
          }}
        />

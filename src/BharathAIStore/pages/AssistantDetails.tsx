...
const AssistantDetails: React.FC = () => {
  ...
  return (
    <AppShell allAgentsHref="/bharath-aistore/agents">
      <div
        className="flex flex-col min-h-[100dvh] overflow-y-auto bg-white dark:bg-gray-800 text-purple-700 dark:text-white"
...
backdrop-blur-md sticky top-0 z-20 "
        ...
        {isFetchingAssistant ? (
          ...
          <>
            <div className="flex-1 px-3 sm:px-6 lg:px-8 py-4 sm:py-6 max-w-4xl mx-auto w-full pb-40">
              {messages.length === 0 ? (
                <div className="flex flex-col items-center justify-center h-full text-center">
                  <div className="w-16 h-16 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 dark:from-cyan-500 dark:via-blue-500 dark:to-indigo-500 rounded-full flex items-center justify-center mb-4 shadow">
                    <Bot className="w-8 h-8 text-white" />

...
const BANKING_CAPABILITIES: Record<Country, { icon: string; label: string; sub: string }[]> = {
 ...
 uae: [
  { icon: "🏦", label: "Banks", sub: "CBUAE licensed · National & foreign banks" },
  { icon: "🏢", label: "Representative Office", sub: "Foreign bank rep offices" },
  { icon: "💾", label: "Stored Value Facilities (SVF)", sub: "E-wallets · Prepaid instruments" },
  { icon: "💳", label: "Card Scheme", sub: "Card network operators" },
  { icon: "🔄", label: "Monetary Intermediary", sub: "Licensed money intermediaries" },
  { icon: "💱", label: "Exchange Business", sub: "Remittance · Forex · WPS" },
  { icon: "💳", label: "Retail Payment Services", sub: "PSPs · Payment gateways" },
  { icon: "🏗️", label: "Loan-Based Crowd Funding", sub: "P2P lending platforms" },
  { icon: "🔢", label: "Large-value Payment System (LVPS)", sub: "Interbank · RTGS systems" },
  { icon: "🏪", label: "Retail Payment System", sub: "Consumer payment infrastructure" },
  { icon: "📂", label: "Finance Companies", sub: "CBUAE licensed finance firms" },
  { icon: "🌐", label: "Open Finance", sub: "Open banking · API platforms" },
],
  saudi: [
    { icon: "🏦", label: "Local Banks", sub: "SAMA licensed · 11 local commercial banks" },
    { icon: "🌍", label: "Branches of Foreign Banks", sub: "23 international bank branches in KSA" },
    { icon: "💳", label: "Digital Banks", sub: "SAMA licensed · STC Bank, Vision, D360 & EZ" },
    { icon: "🔄", label: "SAMA Finance Companies", sub: "Real estate, consumer, SME, BNPL & microfinance" },
    { icon: "🤝", label: "SAMA Finance Companies - Crowdfunding", sub: "Debt-based crowdfunding platforms" },
    { icon: "🔗", label: "SAMA Finance Support Companies", sub: "Finance aggregators · Lease registries" },
...
const INSURANCE_CAPABILITIES: Record<Country, { icon: string; label: string; sub: string }[]> = {
  ...
  uae: [
    ...
    sub: "Licensed insurers"
  },
  {
    icon: "🤝",
    label: "Profession for Insurance",
    sub: "Brokers, agents, actuaries, consultants"
  },
  ],
  saudi: [
    { icon: "🏢", label: "Insurance Companies KSA", sub: "30+ IA licensed cooperative insurers (Takaful)" },
    { icon: "🔄", label: "Reinsurance Companies KSA", sub: "Saudi Re & international reinsurers in KSA" },
    { icon: "🤝", label: "Insurance Brokers KSA", sub: "Aon, Marsh, Al Mostashar & 100+ IA licensed brokers" },
    { icon: "🏦", label: "Bancassurance & Agents KSA", sub: "Bank-linked & corporate insurance agents" },
    { icon: "🔧", label: "Insurance Service Providers KSA", sub: "Loss adjusters · TPAs · Claims admins · Surveyors" },
  ],
};

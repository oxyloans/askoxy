...
const ADIBAIIntelligenceReport2026: React.FC = () => {
  ...
  return (
    <>
      <style>{styles}</style>
      <div style={{ position: "sticky", top: 0, zIndex: 999, background: "linear-gradient(135deg,#004d26 0%,#003318 100%)", borderBottom: "2px solid #c9a227", padding: "10px 24px", display: "flex", alignItems: "center", justifyContent: "space-between", boxShadow: "0 2px 12px rgba(0,0,0,0.18)" }}>

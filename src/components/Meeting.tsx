  ...
  return (
    <div className="container1">
      <div className="header">
        ...
        <h4  >Join us for an insightful session exploring the capabilities and applications of Generative AI for learners, developers, entrepreneurs, and investors.</h4>
      </div>

...
import poojitha from "../assets/img/WhatsApp Image 2025-01-24 at 15.54.06 (1).png";
    ...
    <div className="bg-gray-50 py-10 min-h-screen">
      ...
      <div className="max-w-7xl mx-auto bg-white rounded-lg shadow-lg p-6 md:flex md:gap-8">
        ...
        <div className="md:w-1/2">
          ...
          <a
            href="https://chat.whatsapp.com/FHZTxHJAONjFXtmFHRz2vn"

  ...
  return (
    <>
      <div className="cbd-ai-intelligence-report-2026">
        <style>{styles}</style>
        <div style={{ position: "sticky", top: 0, zIndex: 999, background: "linear-gradient(135deg,#003366 0%,#002244 100%)", borderBottom: "2px solid #c9a227", padding: "10px 24px", display: "flex", alignItems: "center", justifyContent: "space-between", boxShadow: "0 2px 12px rgba(0,0,0,0.18)" }}>

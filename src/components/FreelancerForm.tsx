...
const FreelancerForm: React.FC = () => {
  ...
  const handleSubmitClick = () => {
    ...
    if (isOpenForFreelancing === "yes") {
      const hasAtLeastOneRate = Object.values(rateCard).some(
        (rate) => rate && rate !== "",
      );
  ...
  return (
    <div
      style={{
        minHeight: "100vh",
        background: "linear-gradient(135deg, #faf5ff 0%,  100%)",
        padding: "16px",
        display: "flex",
        alignItems: "center",
    ...
    >
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
              ...
              <div>
                ...
                <p style={{ color: "#e9d5ff", fontSize: "14px", margin: 0 }}>
                  Complete your freelance profile
                </p>
              </div>
            </div>
          </div>
            ...
            >
              <p style={{ fontSize: "12px", color: "#7e22ce", margin: 0 }}>
                <span style={{ fontWeight: "600" }}>
                  Welcome to ASKOXY.AI. We help professionals showcase their
                  skills, connect with opportunities, and receive fair payouts
                  for their work.
                </span>
              </p>
            </div>
            ...
            {isOpenForFreelancing && isOpenForFreelancing === "yes" ? (
              <>
                ...
                <div style={{ marginBottom: "24px" }}>
                  ...
                  >
                    ...
                    >
                      How much would you like to charge (in INR)?
                    </h3>
                  </div>
                  ...
                  >
                    {(
                      ["hour", "day", "week", "month", "year"] as RatePeriod[]
                    ).map((period) => (
                      <div
                        key={period}
                        style={{
                      ...
                      >
                        ...
                        <select
                          ...
                          onChange={(e) =>
                            handleRateChange(period, e.target.value)
                          }
                          style={{
                            width: "100%",
                            padding: "8px 12px",
                  ...
                  >
                    <p
                      style={{ fontSize: "12px", color: "#7e22ce", margin: 0 }}
                    >
                      <span style={{ fontWeight: "500" }}>
                        Rate Guidelines:
                      </span>{" "}
                      In India per hour ₹125-500, per day ₹1000-2000, per week
                      ₹5000-10,000, per month ₹20,000-30,000
                    </p>
                  </div>
              ...
              <div style={{ marginBottom: "24px" }}>
                ...
                >
                  ...
                  <p style={{ color: "#e9d5ff", margin: "0 0 24px 0" }}>
                    Upload your resume to apply for full-time positions
                  </p>
                  ...
                  >
                    ...
                    />
                    <label
                      htmlFor="fulltime-resume-upload"
                      style={{ cursor: "pointer" }}
                    >
                      {uploadLoading ? (
                        <div
      ...
      >
        <p>
          Your profile is incomplete. Please complete your profile first to
          continue with freelancer registration.
        </p>
      </Modal>
        ...
        <div style={{ padding: "20px 0" }}>
          ...
          >
            ...
            >
              <div
                style={{
                  ...
                  height: "8px",
                  background:
                    isOpenForFreelancing === "yes" ? "#10b981" : "#f59e0b",
                  borderRadius: "50%",
                  marginRight: "12px",
                }}
              ></div>
              ...
              <span
                style={{
                  color: isOpenForFreelancing === "yes" ? "#10b981" : "#f59e0b",
                  fontWeight: "600",
                  marginLeft: "8px",
                }}
              >
            ...
            {isOpenForFreelancing === "yes" && (
              <>
                    ...
                    {Object.entries(rateCard).map(
                      ([period, rate]) =>
                        rate && (
                          ...
                          >
                            <span
                              style={{ color: "#7e22ce", fontSize: "13px" }}
                            >
                              {periodLabels[period as RatePeriod]}
                            </span>
                            <span
                              style={{
                                color: "#9333ea",
                ...
                >
                  ...
                  <span
                    style={{
                      color: isRateNegotiable === "yes" ? "#10b981" : "#ef4444",
                      fontWeight: "600",
                    }}
                  >
            ...
            >
              ...
              <span
                style={{
                  color: resumeFile?.name ? "#10b981" : "#ef4444",
                  fontWeight: "500",
                }}
              >
      ...
      >
        <div style={{ textAlign: "center", padding: "40px 20px" }}>
          ...
          >
            ...
            >
              🎉 You're all set! Your profile is now live and ready for
              opportunities.
            </p>
          </div>
        </div>

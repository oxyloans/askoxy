...
return (
  ...
  <div className="flex flex-col flex-grow overflow-hidden bg-white shadow-md md:flex-row rounded-2xl">
    ...
    {/* Center Panel */}
    <section className="relative flex flex-col flex-grow p-6 bg-gray-50 md:rounded-none md:w-3/4"> {/* Adjusted width for medium screens */}
      {/* Chat messages */}
      <div
      ...
      >
            ...
            <div>
              {item &&
                <>
                <div className='center'  style={{height:'100%',width:'100%',display:'flex', alignItems:'center',justifyContent:'center', position:'absolute' , bottom:1 ,marginLeft:'-2rem' , gap:'2rem',flexWrap:'wrap'}}>
                  <div   className='image_conatiner'     onClick={() =>{  setInput("Do you use rice for daily meals or special dishes like biryani?");
    setitem(false);} }>Do you use rice for daily meals or special dishes like biryani?</div>
                  <div   className='image_conatiner'  onClick={() =>{  setInput("Are you looking for organic or regular rice.?");
    setitem(false);} }>Are you looking for organic or regular rice?</div>
                  <div   className='image_conatiner' onClick={() =>{  setInput("What’s your priority when buying rice: price, quality, or origin?");
    setitem(false);} } >What’s your priority when buying rice: price, quality, or origin?</div>

        ...
        <Modal.Body>
          <div className="mb-3">
            ...
            >
              ...
              />
              <label className="btn btn-outline-primary" htmlFor="whatsapp">
                WhatsApp Verify
              </label>
              ...
              <input
                ...
                id="pan"
                autoComplete="off"
                checked={verificationMethod === "pan"}
                onChange={() => setVerificationMethod("pan")}
              />
              <label className="btn btn-outline-primary" htmlFor="pan">
                PAN Verify
              </label>
            </div>
          </div>

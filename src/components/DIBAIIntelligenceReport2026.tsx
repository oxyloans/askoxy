  ...
  return (
    <>
      <div className="dib-ai-intelligence-report-2026">
        <style>{styles}</style>
        <div style={{ position: "sticky", top: 0, zIndex: 999, background: "linear-gradient(135deg,#004d00 0%,#003318 100%)", borderBottom: "2px solid #c8a84b", padding: "10px 24px", display: "flex", alignItems: "center", justifyContent: "space-between", boxShadow: "0 2px 12px rgba(0,0,0,0.18)" }}>

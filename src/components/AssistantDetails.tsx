...
const AssistantDetails: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <header className="flex items-center justify-between px-4 sm:px-6 bg-gradient-to-t from-white via-white/95 to-transparent dark:from-gray-800 dark:via-gray-800/95 dark:to-transparent backdrop-blur-md sticky top-0 z-20 py-1">
        <div className="min-w-0">
          <button
            onClick={handleBack}
            className="text-base sm:text-lg font-semibold text-purple-800 dark:text-white"
          >
        ...
        <div className="flex items-center ml-4">
          <button
            ...
            className="flex items-center text-lg font-medium gap-2 px-3 py-2 rounded-lg text-purple-800 dark:text-white hover:text-purple-900 dark:hover:text-gray-100 transition-colors duration-200 shrink-0"
      ...
      {isFetchingAssistant ? (
        <div className="flex-1 flex items-center justify-center">
          <Loader2 className="animate-spin w-8 h-8 text-purple-800 dark:text-white" />
        </div>
      ) : (
        <>
          <div
          ...
          >
            {messages.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-full text-center">
                <div className="w-16 h-16 bg-indigo-100 dark:bg-indigo-900 rounded-full flex items-center justify-center mb-4 shadow">
                  <Bot className="w-8 h-8 text-purple-800 dark:text-white" />
                </div>
                <h2 className="text-xl sm:text-2xl font-semibold text-purple-800 dark:text-white">
                  Welcome to {assistant?.name}
                </h2>
                <p className="text-gray-700 dark:text-white max-w-md mt-2">
              ...
              <>
                  ...
                  >
                    ...
                    >
                      <div className="flex gap-2">
                        {msg.role === "assistant" ? (
                          <Bot className="w-5 h-5 text-purple-800 dark:text-white shrink-0 mt-1" />
                        ) : (
                        ...
                        <MarkdownRenderer
                          className={`prose prose-sm sm:prose-base max-w-none ${
                            msg.role === "assistant"
                              ? "prose-indigo dark:prose-invert text-purple-800 dark:text-white"
                      ...
                      {msg.role === "assistant" && (
                        <div className="flex justify-end gap-2 mt-2">
                          <button
                            ...
                            className="p-1 rounded-md hover:bg-gray-100 dark:hover:bg-gray-600 text-purple-800 dark:text-white"
                            title="Copy"
                          >
                ...
                {loading && (
                  <div className="flex justify-start mb-3 sm:mb-4">
                    <div className="bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-2xl px-4 py-3 shadow flex items-center gap-2 text-purple-800 dark:text-white">
                      <Loader2 className="w-5 h-5 animate-spin text-purple-800 dark:text-white" />
          ...
          <div className="fixed bottom-0 left-0 right-0 bg-gradient-to-t from-white via-white/95 to-transparent dark:from-gray-800 dark:via-gray-800/95 dark:to-transparent px-3 sm:px-4 pb-4 pt-2">
            <div className="w-full max-w-3xl mx-auto flex items-center gap-2 rounded-full border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 shadow-md px-3 sm:px-5 py-2 sm:py-3 focus-within:ring-2 focus-within:ring-indigo-500 transition">
              <button
                ...
                className={`flex-shrink-0 w-8 h-8 sm:w-9 sm:h-9 flex items-center justify-center rounded-full transition ${
                  isRecording
                    ...
                    : "text-purple-800 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-600"
                }`}
              ...
              <input
                type="text"
                className="flex-1 min-w-0 bg-transparent outline-none px-2 p-1 text-sm sm:text-base placeholder-purple-800 dark:placeholder-white text-purple-800 dark:text-white"
              ...
              <button
                ...
                className="flex-shrink-0 w-8 h-8 sm:w-9 sm:h-9 flex items-center justify-center rounded-full text-purple-800 dark:text-white hover:bg-indigo-600 hover:text-white disabled:opacity-50 transition"
              >

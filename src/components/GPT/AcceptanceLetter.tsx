...
const AcceptanceLetter = () => {
  ...
  const handleSend = async (queryInput: string) => {
    ...
    try {
      ...
      const apiurl =
        userId !== null
          ? `https://meta.oxyloans.com/api/student-service/user/offerletterAcceptance`
          : `https://meta.oxyloans.com/api/student-service/user/offerletterAcceptance`;
  ...
  const offerAndAcceptanceLetterTopics = [
    {
      id: 1,
      title: "Key Details in Offer Letters",
      content:
        "What crucial information should students look for in an offer letter, such as program details, conditions, and deadlines?",
    },
    {
      id: 2,
      title: "Conditional vs. Unconditional Offers",
      content:
        "How can students differentiate between conditional and unconditional offer letters, and what steps should they take for each?",
    },
    {
      id: 3,
      title: "Submitting an Acceptance Letter",
      content:
        "What is the process for submitting an acceptance letter, and what key elements should it include to confirm admission?",
    },
    {
      id: 4,
      title: "Deadlines and Next Steps",
      content:
        "What are the typical deadlines for accepting an offer, and what next steps should students take after acceptance, such as paying deposits or applying for a visa?",
    },
  ];
          ...
          <section className="relative flex flex-col flex-grow w-full p-6 md:w-1/2 bg-gray-50">
            ...
            {showStaticBubbles && (
              <div className="absolute inset-0 flex items-center justify-center p-3 ">
                <div className="grid grid-cols-2 gap-2">
                  ...
                  {offerAndAcceptanceLetterTopics.map((topic) => (
                    <div
                      key={topic.id}
            ...
            <div className="absolute inset-x-0 bottom-0 flex items-center p-2 bg-white border-t border-gray-300 md:relative">
              <input
                ...
                placeholder="Ask about scholarships for studying abroad...."

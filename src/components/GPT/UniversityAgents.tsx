  ...
  const riceTopics = [
    {
      ...
      content:
        "Learn how university agents can guide you in choosing the right course based on your academic background and career goals.",
    },
    {
      id: 2,
      title: "What services do university agents provide?",
      content:
        "Find out about the various services agents offer, including application assistance, visa processing, and pre-departure support.",
    },
    {
      id: 3,
      title: "How do I choose a reliable university agent?",
      content:
        "Get tips on selecting a trustworthy and accredited agent to ensure smooth and transparent guidance throughout the application process.",
    },
    {
      id: 4,
      title: "Do university agents charge fees for their services?",
      content:
        "Understand the cost structure of working with agents, including whether they charge directly or receive commissions from universities.",
    },
  ];

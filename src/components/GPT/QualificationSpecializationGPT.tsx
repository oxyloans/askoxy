...
const QualificationSpecializationGPT = () => {
  ...
  // Dummy data for Qualification & Specialization and Continuing Education
  const QualificationSpecializationGPT = [
    {
      id: 1,
      title:
        "What ongoing support and adjustments are available for international students?",
      content:
        "What factors should I consider when selecting a university for studying abroad, such as rankings, course offerings, and location?",
    },
    {
      id: 2,
      title: "Qualification & Specialization",
      content:
        "What should I keep in mind when selecting a specialization or degree program that aligns with my career goals?",
    },
    {
      id: 3,
      title: " continuing education while abroad",
      content:
        "How can I continue my education after completing my degree, such as through certifications, post-graduate programs, or online learning?",
    },
    {
      id: 4,
      title: "Universities in usa",
      content:
        "What types of support services do universities provide, such as academic counseling, mental health support, or assistance with cultural adjustments?",
    },
  ];
          ...
          <section className="relative flex flex-col flex-grow w-full p-6 md:w-1/2 bg-gray-50">
            ...
            {showStaticBubbles && (
              <div className="absolute inset-0 flex items-center justify-center p-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  {QualificationSpecializationGPT.map((topic) => (
                    <div
                      key={topic.id}
            ...
            <div className="absolute inset-x-0 bottom-0 flex items-center p-2 bg-white border-t border-gray-300 md:relative">
              <input
                ...
                placeholder="Ask about qualification and specilization for studying abroad...."
...
export default QualificationSpecializationGPT;

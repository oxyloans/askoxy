  ...
  const riceTopics = [
    {
      ...
      content:
        "What factors should students consider when selecting a university abroad, such as reputation, location, course offerings, and student support services?",
    },
    {
      id: 2,
      title: "Admission Requirements in UK University",
      content:
        "What are the general admission requirements for international students, including academic qualifications, standardized test scores, and language proficiency?",
    },
    {
      id: 3,
      title: "Eligibility Criteria for Specific Programs",
      content:
        "How can students check if they are eligible for specific programs or courses abroad, and what prerequisites or qualifications are needed?",
    },
    {
      id: 4,
      title: "Scholarships and Financial Aid",
      content:
        "What scholarships or financial aid options are available for international students, and how can students apply for them to meet eligibility criteria?",
    },
  ];
      ...
      <header className="flex flex-col md:flex-row justify-between items-center p-4 bg-[#351664] border-b-2 border-white">
        ...
        <div className="flex flex-col space-y-2 md:flex-row md:space-y-0 md:space-x-4">
          <AuthorInfo
            ...
            // Optional, falls back to placeholder image
          />
        </div>
      </header>
          ...
          <section className="relative flex flex-col flex-grow w-full p-6 md:w-1/2 bg-gray-50">
            ...
            <div className="absolute inset-x-0 bottom-0 flex items-center p-2 bg-white border-t border-gray-300 md:relative">
              <input
                ...
                placeholder="Ask about University Details for studying abroad...."

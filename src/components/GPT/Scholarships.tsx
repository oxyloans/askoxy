...
const Scholarship = () => {
  ...
  const handleSend = async (queryInput: string) => {
    ...
    try {
      ...
      const apiurl =
        userId !== null
          ? `https://meta.oxyloans.com/api/student-service/user/scholarship`
          : `https://meta.oxyloans.com/api/student-service/user/scholarship`;
...
const ScholarshipTopic = [
  {
    id: 1,
    title: "Study Abroad Scholarships",
    content:
      "Learn about various scholarships available for international students, including merit-based, need-based, and country-specific scholarships.",
  },
  {
    id: 2,
    title: "US Study Abroad Scholarships",
    content:
      "Explore the best scholarships for US students planning to study abroad, covering tuition, living expenses, and travel grants.",
  },
  {
    id: 3,
    title: "Graduate Scholarships Abroad",
    content:
      "Discover scholarships specifically for graduate students who wish to study abroad, including those offered by universities and government programs.",
  },
  {
    id: 4,
    title: "INSEAD MBA Program Scholarships",
    content:
      "Get information on scholarships available for students applying to the INSEAD MBA program, including need-based and merit-based options.",
  },
];

...
const AccreditationsRecognization = () => {
  ...
  const accreditationTopics = [
    {
      id: 1,
      title: "Importance of Global Accreditations",
      content:
        "Why are global accreditations important for educational institutions, and how do they impact the value of a degree?",
    },
    {
      id: 2,
      title: "Recognized Accreditation Bodies",
      content:
        "What are some well-known global accreditation bodies, and how can students verify if an institution is accredited?",
    },
    {
      id: 3,
      title: "Accreditations and Career Opportunities",
      content:
        "How does studying at an institution with global recognition affect career prospects and opportunities for further education?",
    },
    {
      id: 4,
      title: "Understanding Accreditation Levels",
      content:
        "What are the different levels of accreditation, such as program-specific vs. institutional, and why do they matter?",
    },
  ];
          ...
          <section className="relative flex flex-col flex-grow w-full p-6 md:w-1/2 bg-gray-50">
            ...
            <div className="absolute inset-x-0 bottom-0 flex items-center p-2 bg-white border-t border-gray-300 md:relative">
              <input
                ...
                placeholder="Ask about accreditations aRecognization for studying abroad...."

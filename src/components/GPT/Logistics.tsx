...
const Logistics = () => {
 ...
 const StudyAbroadLogistics = [
   {
     id: 1,
     title: "Essential items to pack for travel?",
     content:
       "Explore various types of accommodation available for international students, including university dormitories, private rentals, and homestays.",
   },
   {
     id: 2,
     title: "Travel Arrangements Us",
     content:
       "Learn how to plan your travel, including booking flights, arranging airport transfers, and understanding visa requirements.",
   },
   {
     id: 3,
     title: "Essential Travel Insurance for Study Abroad",
     content:
       "Understand the importance of travel insurance, including coverage for health, lost baggage, and trip cancellations during your study abroad journey.",
   },
   {
     id: 4,
     title: "Best ways to book study abroad flights?",
     content:
       "Get tips on how to find affordable and comfortable housing options while studying abroad, whether on-campus or off-campus.",
   },
 ];
          ...
          <section className="relative flex flex-col flex-grow w-full p-6 md:w-1/2 bg-gray-50">
            ...
            {showStaticBubbles && (
              <div className="absolute inset-0 flex items-center justify-center p-3 ">
                <div className="grid grid-cols-2 gap-2">
                  ...
                  {StudyAbroadLogistics.map((topic) => (
                    <div
                      key={topic.id}
            ...
            <div className="absolute inset-x-0 bottom-0 flex items-center p-2 bg-white border-t border-gray-300 md:relative">
              <input
                ...
                placeholder="Ask about Logistics for studying abroad...."

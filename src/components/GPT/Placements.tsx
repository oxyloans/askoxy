...
const Placements = () => {
  ...
  // Dummy data for study abroad placement-related topics
  const placementTopics = [
    {
      id: 1,
      title: "Top Countries for Placements",
      content:
        "Which countries are known for offering excellent job opportunities to international students after graduation?",
    },
    {
      id: 2,
      title: "Essential Placement Skills",
      content:
        "What skills should students develop during their studies to enhance their chances of securing placements abroad?",
    },
    {
      id: 3,
          ...
          <section className="relative flex flex-col flex-grow w-full p-6 md:w-1/2 bg-gray-50">
            ...
            <div className="absolute inset-x-0 bottom-0 flex items-center p-2 bg-white border-t border-gray-300 md:relative">
              <input
                ...
                placeholder="Ask about placements for studying abroad...."

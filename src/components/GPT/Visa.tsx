  ...
  const visaTopics = [
    {
      ...
      content:
        "What are the common types of student visas available, and how can students determine which one they need?",
    },
    {
      id: 2,
      title: "Visa Application Process",
      content:
        "What are the typical steps involved in applying for a student visa, and what documents are required?",
    },
    {
      id: 3,
      title: "Common Visa Interview Questions",
      content:
        "What are the frequently asked questions in a student visa interview, and how can students prepare effectively?",
    },
    {
      id: 4,
      title: "Managing Visa Timelines",
      content:
        "How can students plan and manage their visa application timelines to ensure they receive approval before their program starts?",
    },
  ];
          ...
          <section className="relative flex flex-col flex-grow w-full p-6 md:w-1/2 bg-gray-50">
            ...
            <div className="absolute inset-x-0 bottom-0 flex items-center p-2 bg-white border-t border-gray-300 md:relative">
              <input
                ...
                placeholder="Ask about visa for studying abroad...."

...
const ApplicationSupport = () => {
  ...
  const applicationSupportTopics = [
    {
      id: 1,
      title: "Understanding the Application Process",
      content:
        "What are the key steps involved in the application process for studying abroad, from research to submission?",
    },
    {
      id: 2,
      title: "Document Preparation Assistance",
      content:
        "What support is available for preparing essential documents like transcripts, letters of recommendation, and personal statements?",
    },
    {
      id: 3,
      title: "Application Deadlines and Timelines",
      content:
        "How can students manage application deadlines effectively, and what resources are available for tracking timelines?",
    },
    {
      id: 4,
      title: "Choosing the Right Programs and Institutions",
      content:
        "What factors should students consider when selecting programs and institutions, and how can application support services help?",
    },
  ];
            ...
            {showStaticBubbles && (
              <div className="absolute inset-0 flex items-center justify-center p-3 ">
                <div className="grid grid-cols-2 gap-2">
                  ...
                  {applicationSupportTopics.map((topic) => (
                    <div
                      key={topic.id}

      ...
      <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between px-4 md:px-8 lg:px-16 py-16 space-y-10 lg:space-y-0">
        ...
        <div className="w-full lg:w-3/5 text-center lg:text-left">
          <div className="bg-white bg-opacity-90 backdrop-blur-md border border-purple-100 rounded-2xl shadow-md p-6 sm:p-8">
            {/* Badge */}
            <div className="inline-block px-4 py-1 text-white text-xs sm:text-sm font-semibold rounded-full bg-gradient-to-r from-purple-400 to-pink-400 mb-4 animate-pulse">
              🎉 LIMITED TIME OFFER
            </div>
            ...
            {/* Coin Value Note */}
            <p className="text-sm text-purple-600 italic mb-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
              {stats.map((item, index) => (
                ...
                >
                  <p className="text-purple-500 text-sm font-bold uppercase">
                    {item.label}
                  </p>
        ...
        <div className="w-full lg:w-2/5 flex justify-center">
          <div className="relative animate-bounce-slow">
            ...
            {/* Coin Image */}
            <div className="relative p-6 bg-white bg-opacity-90 rounded-full shadow-md">
              <img
                src={coinImage}
                alt="BMV Coin Promo"
                className="w-40 sm:w-48 md:w-56 lg:w-64 rounded-full shadow-sm"
                loading="lazy"
              />
            </div>
          </div>

    ...
    <div className="max-w-6xl mx-auto p-4 space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-white shadow-md p-6 rounded-lg">
          ...
          <span>
  1. Visit the <a href="https://www.askoxy.ai/" target="_blank" className="text-blue-500 underline">askoxy.ai</a> website.
</span>
        ...
        <div className="bg-white shadow-md p-6 rounded-lg">
          ...
          <span>
           1. Visit the <a href="https://www.askoxy.ai/" target="_blank" className="text-blue-500 underline">askoxy.ai</a> website.
            ...
            <span className="block">    - If everything is correct, click "Confirm."</span>

...
const FreeSample: React.FC = () => {
  ...
  const showConfirmationModal = (isAlreadyInterested: boolean, role: string) => {
    ...
    Modal.confirm({
      ...
      content: `Are you sure you want to participate in the Free Samples Training offer as ${role || "a participant"}?`,
      okText: "Yes, I’m sure",
      cancelText: "Cancel",
          ...
          <div className="bg-white rounded-xl p-6 shadow-xl w-full max-w-3xl mx-4">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600 text-sm">
                Choose how you'd like to participate in our FREESAMPLE offer
              </p>
            </div>

...
import CacsHeroSection from "./CaCsServicesHeroSection";
import CacsHeader from "./CaCsHeader";
import CacsFooter from "./CaCsServicesFooter";
import OurServicesCarousel from "./CaCsServicesOurServices";
...
export default function CACSService() {
  ...
  return (
    <div className="flex flex-col min-h-screen" onClick={handleContentClick}>
      <CacsHeader onNavClick={scrollToSection} activeLink={activeLink} />

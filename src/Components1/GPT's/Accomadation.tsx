...
const AccomidationGpt: React.FC = () => {
  ...
  const riceTopics = [
    { id: 1, title: "Accommodation Types", content: "Discover useful tips!" },
  ...
  const handleSend = async (queryInput: string) => {
    ...
    try {
      ...
      const apiUrl = `https://meta.oxyloans.com/api/student-service/user/chat?InfoType=${encodeURIComponent(queryInput)

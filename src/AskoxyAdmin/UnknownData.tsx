...
const UnknownData: React.FC = () => {
  const [records, setRecords] = useState<UnknownDataItem[]>([]);
  ...
  const fetchRecords = useCallback(async () => {
    ...
    try {
      const response = await axios.get(
        `${BASE_URL}/ai-service/entity-records/unknow-data`,
        {
          params: { page, size },
        }
      );
  ...
  const columns: ColumnsType<UnknownDataItem> = [
    {

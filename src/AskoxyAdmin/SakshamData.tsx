...
const SakshamData: React.FC = () => {
  const [records, setRecords] = useState<SakshamItem[]>([]);
  ...
  const fetchRecords = useCallback(async () => {
    ...
    try {
      const response = await axios.get(
        `${BASE_URL}/ai-service/entity-records/saksham`,
        {
          params: { page, size },
        }
      );
  ...
  const columns: ColumnsType<SakshamItem> = [
    {

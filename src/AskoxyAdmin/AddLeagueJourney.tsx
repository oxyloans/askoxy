        ...
        <form onSubmit={onSubmit} className="bg-white rounded-lg shadow p-6">
          ...
          <div className="mb-5">
            <label className="block text-sm font-medium text-gray-700 mb-1">
              <strong>League Journey Name</strong>
            </label>
            <input
              type="text"
              placeholder="Enter league journey name"
              value={form.jobRole}
          ...
          <div className="mb-5">
            <label className="block text-sm font-medium text-gray-700 mb-1">
              <strong>League Journey Description</strong>
            </label>
            <textarea
              rows={6}
              placeholder="Enter league journey description"
          ...
          >
            {isSubmitting ? "Submitting..." : "Add League Journey"}
          </button>
        </form>
      </div>
    </div>

...
// import { FaSearch, FaTimes, FaMicrophone, FaSpinner } from "react-icons/fa";
...
//     }
//   }, [searchValue, location.pathname, isVoiceRouteActive, isFocused, navigate]);
...
//           className="w-full min-w-0 pl-4 pr-12 py-2.5 border-2 border-gray-200 rounded-full text-sm focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none transition-all duration-300 hover:border-purple-400 hover:shadow-md"
...
//         <div
//           ref={dropdownRef}
//           className="absolute left-0 right-0 z-[1050] mt-2 w-full bg-white border border-gray-200 rounded-lg shadow-xl max-h-[320px] md:max-h-96 overflow-y-auto"

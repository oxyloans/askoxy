    ...
    <div className="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-lg">
      ...
      <p className="text-gray-600">
        ...
        <ul className="list-disc pl-6">
          ...
          <li><strong>Application</strong> refers to ASKOXY.AI, the software program provided by the Company.</li>
          <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to OXYKART TECHNOLOGIES PVT LTD, CC-02, Ground Floor, Indu Fortune Fields, KPHB Colony, Hyderabad, Telangana - 500085</li>
      ...
      <h3 className="text-lg font-medium mt-4 mb-2">Use of Your Personal Data</h3>
      <p className="text-gray-600">
      ...
      <h3 className="text-lg font-medium mt-4 mb-2">Retention of Your Personal Data</h3>
      <p className="text-gray-600">
      ...
      <h3 className="text-lg font-medium mt-4 mb-2">Transfer of Your Personal Data</h3>
      <p className="text-gray-600">
      ...
      <h3 className="text-lg font-medium mt-4 mb-2">Delete Your Personal Data</h3>
      <p className="text-gray-600">
      ...
      <h3 className="text-lg font-medium mt-4 mb-2">Disclosure of Your Personal Data</h3>
      <h4 className="text-md font-medium mt-3 mb-1">Business Transactions</h4>
      <p className="text-gray-600">
        If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.
      </p>
      <h4 className="text-md font-medium mt-3 mb-1">Law Enforcement</h4>
      <p className="text-gray-600">
        Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).
      </p>
      <h4 className="text-md font-medium mt-3 mb-1">Other Legal Requirements</h4>
      <p className="text-gray-600">
      ...
      <h3 className="text-lg font-medium mt-4 mb-2">Security of Your Personal Data</h3>
      <p className="text-gray-600">
      ...
      <p className="text-gray-600">
        Our Service may contain links to other websites that are not operated by Us. If You click on a third party link, we strongly advise You to review the Privacy Policy of every site you visit. We have no control over and assume no responsibility for the content, privacy policies or practices of any third party sites or services.
      </p>

      <h2 className="text-xl font-semibold mt-6 mb-2">Changes to this Privacy Policy</h2>
      <p className="text-gray-600">
        We may update Our Privacy Policy from time to time. We will notify You of any changes by posting the new Privacy Policy on this page. We will let You know via email and/or a prominent notice on Our Service, prior to the change becoming effective and update the "Last updated" date at the top of this Privacy Policy. You are advised to review this Privacy Policy periodically for any changes. Changes to this Privacy Policy are effective when they will be posted on this page.
      </p>
      ...
      <p className="text-gray-600">
        ...
        <ul className="list-disc pl-6">
          <li><strong>Email:</strong> support@askoxy.ai</li>
          <li><strong>Address:</strong> OXYKART TECHNOLOGIES PVT LTD, CC-02, Ground Floor, Indu Fortune Fields, KPHB Colony, Hyderabad, Telangana - 500085</li>
        </ul>
      </p>
    </div>
  );

...
import GoldAndSilverAndDiamondHeader from "./GoldAndSilverAndDiamondsHeader";
import GoldAndSilverAndCacsFooter from "./GoldAndSilverAndDiamondsFooter";
import GoldAndSilverAndOurServicesCarousel from "./GoldAndSilverAndDiamondsOurServices";
import GoldAndSilverAndDiamondHeroSection from "./GoldAndSilverAndDiamondsHeroSection";
...
export default function GoldAndSilverAndDiamond() {
  ...
  return (
    <div className="flex flex-col min-h-screen" onClick={handleContentClick}>
      <GoldAndSilverAndDiamondHeader
        onNavClick={scrollToSection}
        activeLink={activeLink}
      />
      <main className="flex-grow">
        <div ref={homeRef} id="home">
          <GoldAndSilverAndDiamondHeroSection />
        </div>
        <div ref={servicesRef} id="services">
          <GoldAndSilverAndOurServicesCarousel />
        </div>
        <div ref={contactRef} id="contact">
          <GoldAndSilverAndCacsFooter />
        </div>
      </main>
    </div>
  );

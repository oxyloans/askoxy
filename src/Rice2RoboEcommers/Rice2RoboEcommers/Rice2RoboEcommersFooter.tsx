        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
          ...
          <div className="col-span-1 md:col-span-2 lg:col-span-1">
            ...
            <p className="text-gray-300 text-sm leading-relaxed mb-6">
              Your smart shopping destination powered by AI technology. From
              electronics to everyday essentials, we provide comprehensive
              e-commerce solutions with intelligent recommendations and seamless
              shopping experience.
            </p>

...
import Rice2RoboEcommersHeader from "./Rice2RoboEcommerHeader";     
import Rice2RoboEcommersHeroSection from "./Rice2RoboEcommersHeroSection";
import Rice2RoboEcommersOurServicesCarousel from "./Rice2RoboEcommersOurServices";
import Rice2RoboEcommersFooter from "./Rice2RoboEcommersFooter";
...
export default function Rice2RoboEcommers() {
  ...
  return (
    <div className="flex flex-col min-h-screen" onClick={handleContentClick}>
      <Rice2RoboEcommersHeader 
        onNavClick={scrollToSection}
        activeLink={activeLink}
      />
      <main className="flex-grow">
        <div ref={homeRef} id="home">
          <Rice2RoboEcommersHeroSection />
        </div>
        <div ref={servicesRef} id="services">
          <Rice2RoboEcommersOurServicesCarousel />
        </div>
        <div ref={contactRef} id="contact">
          <Rice2RoboEcommersFooter />
        </div>
      </main>
    </div>
  );
